...
public class ServerArgumentParser {
    ...
    public boolean isValid() {
        ...
        if (args.length != 2) {
            GlobalLogger.severe(this, "Invalid number of arguments, must specify both port " +
                    "number and thread pool size.");
            return false;
        }
        ...
        if (portNum < 0) {
            ...
            GlobalLogger.warning(this, "You are running in the restricted port range, " +
